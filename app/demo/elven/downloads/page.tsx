    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <Download className="w-16 h-16 text-[#27AE60] mx-auto mb-4" />
          <h1 className="text-4xl font-bold text-white mb-4">Descargas</h1>
          <p className="text-[#A0C4B0]">Descarga el cliente y comienza tu aventura</p>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl bg-[#27AE60]/20 flex items-center justify-center"
                  >
                    <FileArchive className="w-7 h-7 text-[#27AE60]" />
                  </div>
                  <div>
              ...
              <div className="flex flex-wrap gap-3">
                {download.mirrors.map((mirror) => (
                  <a
                    key={mirror.name}
                    href={mirror.url}
                    className="px-4 py-2 rounded-lg font-medium text-[#0F2918] bg-[#27AE60] hover:bg-[#2ECC71] transition-colors"
                  >
        ...
        <motion.div
          ...
          className="mt-12 p-6 rounded-2xl bg-[#1A3A2A]/50 border border-[#27AE60]/20"
        >
          <div className="flex items-center gap-4 mb-6">
            <Monitor className="w-8 h-8 text-[#27AE60]" />
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-[#A0C4B0]">
