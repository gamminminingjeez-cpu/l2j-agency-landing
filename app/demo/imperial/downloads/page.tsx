    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <Download className="w-16 h-16 text-[#C9A962] mx-auto mb-4" />
          <h1 className="text-4xl font-bold text-white mb-4">Descargas</h1>
          <p className="text-[#D4C4A8]">Descarga el cliente y comienza tu aventura</p>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  >
                    <FileArchive className="w-7 h-7 text-[#C9A962]" />
                  </div>
                  <div>
              ...
              <div className="flex flex-wrap gap-3">
                {download.mirrors.map((mirror) => (
                  <a
                    key={mirror.name}
                    href={mirror.url}
                    className="px-4 py-2 rounded-lg font-medium text-[#1A1714] bg-[#C9A962] hover:bg-[#E5D4A1] transition-colors"
                  >
        ...
        <motion.div
          ...
          className="mt-12 p-6 rounded-2xl bg-[#2A2520]/50 border border-[#C9A962]/20"
        >
          <div className="flex items-center gap-4 mb-6">
            <Monitor className="w-8 h-8 text-[#C9A962]" />
